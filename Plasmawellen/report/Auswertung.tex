...
\begin{align}
  \omega_{\mathrm{p}}=\sqrt{\frac{e^2 n}{\epsilon_0 m_{\mathrm{e}}}} = 56.5\ \mathrm{s}^{-1}\mathrm{m}^{3/2}\ \sqrt{n}
\end{align}
Durch Umstellen der Gleichung erhält man
\begin{align}
  n=\left( \frac{\omega_{\mathrm{p}}}{56.5\ \mathrm{s}^{-1}\mathrm{m}^{3/2}} \right)^2=\left( \frac{2 \pi f_{\mathrm{p}}}{56.5\ \mathrm{s}^{-1}\mathrm{m}^{3/2}} \right)^2.
\end{align}
