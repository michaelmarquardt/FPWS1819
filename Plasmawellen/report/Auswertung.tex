...
\begin{align}
  ...
  k & = \frac{2 \pi}{\lambda}
\end{align}
Der Fehler $\Delta k$ wird mittels Fehlerfotpfanltung berechnet, wobei für die Wellenlänge $\Delta \lambda=0.1$ cm angenommen wird.
\begin{align}
...
\end{align}
zum fitten benutzt werden, wobei $T_{\mathrm{e}}$ die Temperatur der Elektronen, $T_{\mathrm{i}}$ die Temperatur der Ionen, $m_{\mathrm{i}}$ die Masse der Ionen ist und $c_{\mathrm{s}}$ die Schallgeschwindigkeit. Das bedeutet durch das Fitten mir einer Geraden
\begin{align}
  f(x)= a x +b
...
Wird die Amplitude der Spannung am Gitter erhöht, kommt es zu einem Übergang von linearen Ionen Akustikwellen zu nicht linieraren Schockwellen.  Dieser Übergang ist mit einem Oszilloskop gemessen worden. Die gemessen Daten sind in den Abbildungen \ref{fig:oszi_2}, \ref{fig:oszi_1} und \ref{fig:oszi_3} dargestellt. Die blaue Kurve ist jeweils das gemessene Signal und die andere Kurve die am Gitter angelegte Spannung. Gut zu erkennen ist, das mit steigender Amplitude der Spannung am Gitter, das gemessene Siganl immer weniger wie eine Sinus-Funtion aussieht. 
\begin{figure}[H]
\centering
