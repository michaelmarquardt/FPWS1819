...
Zuletzt kann noch die Plasmafrequenz \eqref{eq:omega} betrachtet werden.
...
\begin{figure}[htbp]
    \centering
    \input{../figures/double_alpha.pgf}
    \caption{
        Ionisationsgrad $\alpha$ in Abh\"angigkeit des Gasdruckes $p$.
        Der Ionisationsgrad sinkt mit steigendem Druck und ist allgemein relativ niedrig.
...
\begin{figure}[htbp]
    \centering
    \input{../figures/radial_KL_I5.pgf}
    \caption{
...
\begin{figure}[htbp]
    \centering
    \input{../figures/radial_KL_I10.pgf}
    \caption{
        Kennlinie der Langmuir-Sonde im Plasma f\"ur verschiedene radiale Positionen im Plasma $\Delta r$.
...
\begin{figure}[htbp]
    \centering
    \input{../figures/radial_KL_I20.pgf}
    \caption{
        Kennlinie der Langmuir-Sonde im Plasma f\"ur verschiedene radiale Positionen im Plasma $\Delta r$.
...
\begin{figure}[htbp]
    \centering
    \input{../figures/radial_alpha.pgf}
    \caption{
