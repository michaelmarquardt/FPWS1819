...
\begin{minipage}[t][][t]{0.48\textwidth}
    \begin{enumerate}
        \item The glass pipette must be formed to ensure the right flow behavior of the particle solution.
        The size of the opening of the pipette is reduced to reduce the flow velocity.
        \item The particle solution is made up of polybead microspheres, ethanol and hexylamine.
        See \cite{wollet10a} for more detail.
        \item The pipette with the particle solution is hold into a petri dish with destilled water.
        The microspheres rise and form a monolayer at the water surface.
        \item \color{red}{Dieser Text kommt vielleicht besser zu den Bildern}
        \item \color{red}{Rechtes Bild kleiner}
    \end{enumerate}
\end{minipage}
\hfill
